  ...
  return (
    <div className="min-h-screen bg-rachma-bg text-rachma-text py-10 px-4 md:px-8">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        {/* Kartu Profil Utama dengan Foto */}
          ...
          <div className="space-y-6 relative before:absolute before:inset-0 before:left-3.5 before:w-0.5 before:bg-rachma-soft">
            {educationHistory.map((item, index) => (
              <div key={index} className="relative pl-10 space-y-1">
                <div className="absolute left-0 top-1.5 w-7 h-7 rounded-full bg-rachma-primary text-white flex items-center justify-center text-xs font-bold shadow-sm">
                  ✓
                </div>
                <span className="text-xs font-bold text-rachma-primary bg-rachma-soft/40 px-2.5 py-0.5 rounded-full inline-block">
                  {item.year}
                </span>
